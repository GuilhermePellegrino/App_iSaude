...
import AdministrativeDashboard from './screens/AdministrativeDashboard';
import CommonUserDashboard from './screens/CommonUserDashboard';
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        <Stack.Screen name="AdministrativeDashboard" component={AdministrativeDashboard} />
        <Stack.Screen name="CommonUserDashboard" component={CommonUserDashboard} />
